...
plt.subplot(221), plt.imshow(cv2.cvtColor(img0, cv2.COLOR_BGR2RGB)), plt.title('Out & True')
plt.subplot(222), plt.imshow(cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)), plt.title('In & True')
plt.subplot(223), plt.imshow(cv2.cvtColor(img2, cv2.COLOR_BGR2RGB)), plt.title('Out & False')
plt.subplot(224), plt.imshow(cv2.cvtColor(img3, cv2.COLOR_BGR2RGB)), plt.title('In & False')
plt.show()
